package com.example.hiroka.views.dashboard;
...
import com.example.hiroka.views.dashboard.ServiceHealth.Status;
...
public class DashboardView extends Main {
    ...
    private Component createHighlight(String title, String value, Double percentage) {
        ...
        H2 h2 = new H2(title);
        h2.addClassNames(FontWeight.NORMAL, LumoUtility.Margin.NONE, TextColor.SECONDARY, FontSize.XSMALL);
